...
function validate() {
    ...
    var nameForm = document.getElementById('fName').value;
    var lastNameForm = document.getElementById('fLastN').value;
    var emailForm = document.getElementById('fEmail').value;
    var adressForm = document.getElementById('fAddress').value;
    var passForm = document.getElementById('fPassword').value;
    var phoneForm = document.getElementById('fPhone').value;
    ...
    if ((phone_validate == null) || (phoneForm.length <= 8)) {
        noErrors = false;
